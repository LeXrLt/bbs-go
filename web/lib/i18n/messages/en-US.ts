  ...
  pages: {
    ...
    topic: {
      ...
      detail: {
        ...
        attachmentFree: "Free",
        attachmentScoreRequired: "{score} pts to unlock",
        attachmentPurchased: "Unlocked",
      ...
      create: {
        ...
        attachment: {
          ...
          scorePlaceholder: "Unlock points",
          add: "Add attachment",
          remove: "Remove",
          maxCountError: "A topic can have up to {maxCount} attachments",
          sizeError: "Each attachment must be no larger than {maxSizeMB} MB",
          typeError: "Supported attachment types: {types}",
        },
        vote: {
          addTitle: "Add vote",
          editTitle: "Edit vote",
      ...
      attachmentPreview: {
        ...
        notFound: "This attachment does not exist or has been removed",
        notPreviewable: "This attachment cannot be previewed online",
        locked: "Previewing this attachment requires {score} points",
        unlockTitle: "Unlock attachment",
        unlockDescription:
          'Unlocking "{fileName}" costs {score} points. You can access it after unlocking.',
    ...
    calendar: {
      ...
      filters: "Filters",
      filterDescription: "Importance filter",
      importance: "Importance",
      importanceAll: "All importance",
      importanceAtLeast: "{count} star and above",
      importanceValue: "Importance: {count} stars",
      searchLabel: "Search calendar events",
      searchPlaceholder: "Search company, ticker, or indicator",
      refresh: "Refresh",
      ...
      loadError: "Calendar is temporarily unavailable",
      loadErrorDescription:
        "The data service did not return a valid result. Try again shortly.",
      retry: "Retry",
      noEvents: "No events for this day",
      noEventsDescription: "There are no calendar events on this date.",
      noEventsFilteredDescription: "No events match the current filters.",
      eventList: "Financial calendar events",
      openEvent: "View event: {title}",
      allDayTbd: "All day / TBD",
      unavailable: "--",
      columns: {
        type: "Type",
        time: "Time / status",
        event: "Event and security",
        keyData: "Key data",
        action: "Action",
      },
      ...
      detailLoadError:
        "Full details could not be loaded. Available list data is shown.",
